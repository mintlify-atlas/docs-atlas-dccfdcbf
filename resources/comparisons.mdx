...
description: How CallApi compares to other popular fetch libraries
...
**Lightweight:** Small bundle size (under 6KB). Zero dependencies. Pure ESM.

**Simple:** Based on the Fetch API and mirrors its interface 1-to-1. Only adds useful features with sensible defaults.

**Type-safe:** Built with TypeScript. Full type support for responses and errors via schemas, validators, and manual generics.
...
<Tabs items={["API Design", "Features", "Bundle Size", "TypeScript"]}>
...
CallApi is more than 50% smaller while providing more features.
...
- [Migration from Axios](/resources/migration-guide#from-axios)
- [Migration from Ky](/resources/migration-guide#from-ky)
- [Migration from Ofetch](/resources/migration-guide#from-ofetch)
