...
- [Plugins Guide](/guides/plugins) - Learn about creating plugins
- [Custom Plugins](/plugins/custom-plugins) - Examples of custom plugins
- [Hooks](/api/hooks) - Lifecycle hooks used by the logger
- [Error Handling](/guides/error-handling) - Understanding error types
