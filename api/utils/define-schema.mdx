...
- [Schema Validation](/api/config/schema) - Learn about schema configuration options
- [Type Safety](/guides/type-safety) - Understanding CallApi's type system
- [Validation](/guides/validation) - Working with request/response validation
